	...
	<title><?php
        ...
        <!--[if IE 8]>
        	<style type="text/css">
				...
				div.tp-caption.argus_black.tp-fade.tp-resizeme.start, div.tp-caption.argus_black_italic.tp-fade.tp-resizeme.start {
				...
				#change_home_tariffs {
					background: url("<?php echo get_stylesheet_directory_uri();?>/images/arrow_down_black.png") no-repeat scroll center center
				}

				#change_home_location, #change_home_contactus {
					background: url("<?php echo get_stylesheet_directory_uri();?>/images/arrow_down.png") no-repeat scroll center center
				}
...
<?php dynamic_sidebar('video-tour');?>

<script type="text/javascript">
jQuery(document).ready(function($) {
	var video_menu = $('.video-tour').html();
	$('.special_video_menu').click(function(){
	console.log('aaa')		;
		//$('.see_how_we_work').trigger('click');
		$('.video-tour a').trigger('click');
		return false;
	})
});
</script>
	...
	<div class="header-wrapper<?php if(etheme_get_option('fade_animation')): ?> fade-in delay1<?php endif; ?> header-type-<?php echo $ht; ?>">
		...
		$header_bg = "";
		if (!is_front_page()){
			$header_bg = "inner_page_header_bg";
		}
		?>
		<div class="main-nav visible-desktop <?php echo $header_bg;?>">
		...
		<?php dynamic_sidebar( 'header-roi' ); ?>
	</div>